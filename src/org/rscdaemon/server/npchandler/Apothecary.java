...
public class Apothecary implements NpcHandler {
	...
	private static final String[] Alts = { "Can you make a strength potion?",
	...
	public void handleNpc(final Npc npc, Player player) throws Exception {
		player.informOfNpcMessage(new ChatMessage(npc,
				"Hello stranger. I am the apothecary", player));
		player.setBusy(true);
													...
													public void action() {
														...
														case 0:
															...
															owner.informOfNpcMessage(new ChatMessage(
																	npc,
																	"Yes. For a small cost",
																	owner));
															world.getDelayedEventHandler()
																	.add(new ShortEvent(
																			owner) {
																		public void action() {
																			InvItem redEggs = owner
																					.getInventory()
																					.get(owner
																							.getInventory()
																							.getLastIndexById(
																			...
																			if (redEggs == null
																				...
																				owner.getActionSender()
																						.sendMessage(
																								"@whi@You hand the ingredients over to the Apothecary");
																				owner.getInventory()
																						.add(new InvItem(
																								221,
																								1));
																				...
																				owner.getActionSender()
																						.sendMessage(
																								"@whi@You recive a strength potion");
																				owner.setBusy(false);
																				npc.unblock();
																			} else {
																				running = false;
														...
														case 1:
															...
															owner.informOfNpcMessage(new ChatMessage(
																	npc,
																	"Indeed i do. I gave it to my mother. That's why i am living alone now",
																	owner));
															owner.setBusy(false);
															npc.unblock();
															break;
