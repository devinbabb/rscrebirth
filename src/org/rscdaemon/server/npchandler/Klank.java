...
public class Klank implements NpcHandler {
	...
	public void handleNpc(final Npc npc, Player player) throws Exception {
		player.informOfNpcMessage(new ChatMessage(
				npc,
				"Would you like me to assemble both halves of your dragon shield?",
				player));
		player.informOfNpcMessage(new ChatMessage(npc,
				"I will do it for a small fee of 10 coins.", player));
		player.setBusy(true);
		world.getDelayedEventHandler().add(new ShortEvent(player) {
			public void action() {
				owner.setBusy(false);
				String[] options = new String[] { "Yes, please.",
						"No, thank you." };
														...
														public void action() {
															...
															if (owner
																...
																owner.getActionSender()
																		.sendMessage(
																				"Oops, you do not have both halves of the shield.");
																owner.setBusy(false);
																npc.unblock();
															} else if (owner
																	.getInventory()
