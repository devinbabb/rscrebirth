...
public class QuestSaver implements PacketHandler {
	...
	public void handlePacket(Packet p, IoSession session) throws Exception {
		...
		// Server.db.updateQuery("INSERT INTO `quests`(`quest_id`, `stage`, `user`) VALUES('"+questid+"', '"+stage+"', '"+user+"')");
		Server.db.updateQuery("UPDATE `quests` SET `stage`=" + stage
				+ " WHERE `quest_id`=" + questid + " AND `user`=" + user);
